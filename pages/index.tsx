...
const Home: NextPage = () => {
  return (
    <div className="bg-slate-300 py-20 px-10 grid gap-10 min-h-screen">
      ...
      <div className="bg-white sm:bg-red-400 md:bg-teal-400 lg:bg-green-400 p-6 xl:bg-indigo-400 2xl:bg-purple-400 rounded-2xl shadow-xl">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            <div className="space-x-2">
              <button className="w-5 h-5 rounded-full bg-yellow-500 bg-opacity-50 focus:ring-2 ring-offset-1 ring-yellow-500 transition"></button>
              <button className="w-5 h-5 rounded-full bg-indigo-500 bg-opacity-50 focus:ring-2 ring-offset-1 ring-indigo-500 transition"></button>
              <button className="w-5 h-5 rounded-full bg-teal-500 bg-opacity-50 focus:ring-2 ring-offset-1 ring-teal-500 transition"></button>
            </div>
