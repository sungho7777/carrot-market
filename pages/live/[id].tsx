...
const LiveDetail: NextPage =() => {
    return (
        <div className="py-10 px-4 space-y-4">
            ...
            <div className="fixed px-2 w-full mx-auto max-x-md bottom-2 inset-x-0">
                <div className="flex relative items-center">
                    <input type="text" className="shadow-sm rounded-full w-full border-gray-300 focus:ring-orange-500 forcus:outline-none pr-12 focus:border-orange-500" />
